...
\def\texDist{/usr/local/texlive/2015/texmf-dist}
\def\tlcDist{/tex/latex/\tlcProduct}
\def\tlcGlobalDist{\texDist\tlcDist}

\def\tlcHome{\$HOME}
\def\tlcMyDoc{\tlcHome/mydoc}
\def\tlcRepo{git@github.com:Traap/\tlcProduct.git}
...
This section describes how to install \tlcA\ either globally to make it avalilbe
to your \LaTeX\ environment or locally to the document you are authoring.
...
\begin{enumerate}
  ...
  \item cd \tlcProduct\
  \item mkdir \tlcGlobalDist
  \item cp -v \tlcProduct.cls \tlcGlobalDist/.
