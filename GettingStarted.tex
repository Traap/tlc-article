...
implementation for each part \tlcA\ organizes. \textbf{Note:} This document was
typeset using the instructions provided throughout this section.
...
\subsection{Title, Author \& Abstract}
...
The Table of Contents immediatly follows the document abstract on page 1, uses
dark blue for content, dots separate items, and are followed by roman numeral. 

\subsection{Header \& Footer}
fancyhdr is use to render the header and footer.  The Author can override the
header and footer by providing an implementation in \tlcHF.
