...
% processed during the preamble phase.  In other words, before your \begin{document}
% statement.

% -------------------------------------------------------------------------- }}}
% {{{ tlc-article.tex (Getting Started) definitions.
...
\def\tlcIC{\tlcDarkblue{tlc@institution}}%
